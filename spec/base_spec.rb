...
describe "MongoAutoIncrement" do
  describe 'Base test' do
    ...
    it "new record Id will not be nil" do
    ...
    it "does return  id when Model.new" do
      expect(Post.new.id).not_to eq nil
      expect(Post.new._id).not_to eq nil
    end
    ...
    it "does 1..N working fine" do
      user1 = User.new(:email => "guptalakshya92@gmail.com",:name => "Jason Lee")
      user1.save
